...
if (dim(specials_na)[1] > 0){
  print(specials_na)
  stop("Player results has NAs")
}
...
# Set Result as factor
games$Result <- factor(
  games$Result,
  levels = results_ordered
)
...
```{r mode results stacked bars}

modes_bars <- modeBarPlots(games)

ggplotly(modes_bars[["stacked_bars"]], height = 400, width = 650)

#ggplotly(modes_bars[["dodged_bars"]], height = 400, width = 650)
